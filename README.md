...
한화시스템 SW 캠프에서는 Java, Spring Boot, AWS, Kubernetes 등의 기술을 활용한 프로젝트 경험이 있습니다. 
팀원들과 협력하여 요구사항을 분석하고, 개발부터 배포까지 전 과정을 경험하였습니다. 
이를 통해 개발자의 역량을 키워나감과 동시에 최종프로젝트 1위로 수료했습니다.


프로젝트를 경험하며 늘 도전하는 것을 즐기고, 문제해결능력과 협업 능력을 갖췄습니다. 
새로운 기술에 대한 열정과 끊임없는 학습의식으로 항상 성장하고자 하는 자세를 바탕으로 조직의 발전에 기여하고 싶습니다.
